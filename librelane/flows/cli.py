    ...
    def decorate(f):
        ...
        if run_options:
            f = o(
                ...
                help="Use these JSON file as an initial state (later ones take precedence). If none are specified, the latest `state_out.json` of the run directory will be used. If none exist, an empty initial state is created.",
            )(f)
            f = o(
                "--design-dir",
                "design_dir",
